...
#define I2C_SDA_PIN   PORTBbits.RB3
#define I2C_SDA_TRIS  TRISBbits.RB3
#define I2C_SDA_LAT   LATBbits.LATB3

#define I2C_SCK_PIN   PORTBbits.RB4
#define I2C_SCK_TRIS  TRISBbits.RB4
#define I2C_SCK_LAT   LATBbits.LATB4
