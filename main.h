...
#define V_SENS_LAT   LATAbits.LATA1
#define V_SENS_TRIS  TRISAbits.RA1

#define INIT_V_SENS  V_SENS_LAT=0; V_SENS_TRIS=1


//Vcc, mV
#define ADC_REF 5000UL
//ADC resolution
#define ADC_RES 1024UL

#define VOLT_DIV 1000UL

#define ADC_VOLT(ADC) (uint16_t)(((((uint32_t)ADC*VOLT_DIV)/1000UL)*ADC_REF)/ADC_RES)
